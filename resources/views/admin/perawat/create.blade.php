    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="page-header">
                <h1 class="page-title">Tambah Perawat Baru</h1>
                <p class="page-subtitle">Registrasi perawat dan assign role ke user yang dipilih.</p>
            </div>
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('admin.perawat.store') }}" class="form-modern">
                    @csrf
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Simpan Perawat</button>
