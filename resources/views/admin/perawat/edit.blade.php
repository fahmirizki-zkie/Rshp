    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="page-header">
                <h1 class="page-title">Edit Data Perawat</h1>
                <p class="page-subtitle">Update informasi perawat yang terdaftar.</p>
            </div>
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('admin.perawat.update', $perawat->id_perawat) }}" class="form-modern">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Update Perawat</button>
